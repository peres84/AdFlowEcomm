...
View our complete design system and UI mockups on Figma:
[**AdFlowEcomm Design System**](https://www.figma.com/slides/UmkQP5p9yQO677VvtscrAz/AdFlowEcomm?node-id=1-54&t=zSy6yqxM57lLZHhc-1)
...
- Modern SPA with TypeScript and React Router
- Real-time progress tracking and interactive UI

**Backend Layer (FastAPI)**
- Form API → Upload API → Images API → Videos API
- RESTful endpoints with async support
- Pydantic validation and error handling

**Service Layer**
- Session Manager: Persistent session storage
- OpenAI Service: Image analysis and prompt generation
- Runware Service: AI image generation
- Luma Service: AI video generation
- FFmpeg Service: Video processing and merging

**External Services**
- OpenAI GPT-4 Vision API
- Runware Image Generation API
- Luma AI Video Generation API
